...
const restaurants = [
  { id: 1, name: "T55 New York Grill Room", description: "Premium dry-aged steaks and signature Tomahawk cuts.", image: "https://images.pexels.com/photos/262978/pexels-photo-262978.jpeg?w=600&h=400&fit=crop" },
  { id: 2, name: "La Costa Poolside", description: "Casual poolside dining with light bites and refreshing drinks.", image: "https://images.pexels.com/photos/2609221/pexels-photo-2609221.jpeg?w=600&h=400&fit=crop" },
  { id: 3, name: "Red Coral Lounge", description: "Stylish lobby lounge with crafted cocktails.", image: "https://images.pexels.com/photos/2609221/pexels-photo-2609221.jpeg?w=600&h=400&fit=crop" }
];

const rooms = [
  { id: 1, name: "Sea View Deluxe", description: "Private balcony with stunning ocean views.", image: "https://images.pexels.com/photos/271618/pexels-photo-271618.jpeg?w=600&h=400&fit=crop" },
  { id: 2, name: "Family Suite", description: "Connecting rooms for shared moments.", image: "https://images.pexels.com/photos/164595/pexels-photo-164595.jpeg?w=600&h=400&fit=crop" },
  { id: 3, name: "Panorama Club Room", description: "Exclusive access to Panorama Club Lounge.", image: "https://images.pexels.com/photos/258154/pexels-photo-258154.jpeg?w=600&h=400&fit=crop" }
];
        ...
        <div className="relative container mx-auto px-4 z-10">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="bg-white/90 backdrop-blur-sm p-8 rounded-2xl shadow-xl border border-amber-100/30">
              ...
              <h2 className="text-4xl md:text-5xl font-serif font-bold mt-2 mb-4 text-gray-800">Your Family Escape by the Sea</h2>
              <p className="text-gray-600 text-lg mb-6 leading-relaxed font-sans font-light">Nestled in one of Pattaya's most peaceful coastal areas, this beachfront resort features sea view rooms, a lagoon pool, spa, and warm Swiss hospitality. Just 2 hours from Bangkok, it's a perfect escape for your next seaside retreat.</p>
            ...
            {restaurants.map((item) => (
              <div key={item.id} className="group bg-white/95 backdrop-blur-md rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-700 hover:-translate-y-4">
                ...
                <div className="p-8">
                  ...
                  <button className="mt-6 text-amber-600 font-semibold hover:text-amber-700 transition-all flex items-center gap-2 group-hover:gap-4 font-sans">Learn more <span className="transition-transform">→</span></button>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {rooms.map((room) => (
              <div key={room.id} className="group relative rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-700 hover:-translate-y-4">
                <img src={room.image} alt={room.name} className="w-full h-80 object-cover group-hover:scale-110 transition-transform duration-700" loading="lazy" />
                ...
                <div className="absolute bottom-0 p-8 text-white">
                  ...
                  <button className="mt-4 px-8 py-3 bg-gradient-to-r from-amber-500 to-amber-700 rounded-full text-sm font-semibold hover:from-amber-600 hover:to-amber-800 transition-all shadow-lg hover:shadow-amber-500/30 transform hover:scale-105 font-sans tracking-wide">View Details</button>
                </div>
              </div>
            ))}
          </div>
            ...
            <div className="flex flex-col md:flex-row justify-between items-center gap-6">
              <div>
                ...
                <div className="flex flex-wrap gap-3 mt-3">
                  <span className="bg-gradient-to-r from-amber-100/70 to-orange-100/70 px-3 py-1.5 rounded-full text-amber-700 text-xs font-medium border border-amber-200/50 font-sans">Sea View Rooms</span>
                  <span className="bg-gradient-to-r from-amber-100/70 to-orange-100/70 px-3 py-1.5 rounded-full text-amber-700 text-xs font-medium border border-amber-200/50 font-sans">Chocolate Hour</span>
                </div>
              </div>
              <button className="px-8 py-3 bg-gradient-to-r from-amber-500 to-amber-700 text-white rounded-full font-semibold hover:from-amber-600 hover:to-amber-800 transition-all duration-500 shadow-lg hover:shadow-amber-500/30 transform hover:scale-105 font-sans tracking-wide">Book Now →</button>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="relative container mx-auto px-4 z-10">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="bg-white/95 backdrop-blur-md p-8 rounded-2xl shadow-2xl border border-rose-100/30 transform hover:-translate-y-2 transition-all duration-500">
              ...
              <button className="mt-8 px-8 py-3 bg-gradient-to-r from-amber-600 to-amber-800 text-white rounded-full font-semibold hover:from-amber-700 hover:to-amber-900 transition-all duration-500 shadow-lg hover:shadow-amber-500/30 transform hover:scale-105 font-sans tracking-wide">Plan Your Wedding →</button>
            </div>
            <div className="hidden md:block">
              <img src="https://images.pexels.com/photos/1024993/pexels-photo-1024993.jpeg?w=800&h=500&fit=crop" alt="Wedding" className="rounded-2xl shadow-2xl transform hover:scale-105 transition-all duration-500" />
            </div>
          </div>
        </div>
      </section>
      ...
      <div className="relative py-12 overflow-hidden bg-cover bg-center" style={{ backgroundImage: backgroundImages.categories }}>
        ...
        <div className="relative container mx-auto px-4 z-10">
          <div className="flex flex-wrap justify-center gap-3">
            {categories.map((cat) => (
              <button key={cat.id} onClick={() => handleCategoryClick(cat.id)} className={`px-5 py-2.5 rounded-full font-semibold transition-all duration-300 flex items-center gap-2 shadow-md font-sans ${activeCategory === cat.id ? "bg-gradient-to-r from-amber-600 to-amber-800 text-white scale-105 shadow-lg" : "bg-white/90 backdrop-blur-sm text-gray-700 hover:bg-white border border-white/30"}`}>
          ...
          <div className="text-center mt-6">
            <p className="text-white text-sm bg-black/30 backdrop-blur-sm inline-block px-4 py-2 rounded-full shadow-sm border border-white/20 font-sans">✦ {filteredServices.length} luxury experiences available ✦</p>
          </div>
        </div>
      </div>

      {/* Services Grid */}
      <div id="services-section" className="relative py-8 overflow-hidden bg-cover bg-center" style={{ backgroundImage: backgroundImages.servicesBg }}>
